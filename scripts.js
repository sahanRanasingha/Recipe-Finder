...
let clearData = () => {
    ...
    userInput.value = ''; // Clear the search input field
    document.querySelector('.container .displaying-message').style.display = 'block'; // Display the message
    document.querySelector('.container').style.paddingBottom = "0"; // Reset padding
};
*/